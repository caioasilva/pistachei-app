...
class Calculo:
    ...
    def calculaMatrix(self):
        ...
        # cria matriz 5x5
        self.matriz = self.criaMatriz(5)
    
    
        # calculo da matriz
        self.matriz[0][1] = self.notas[0]
        self.matriz[0][2] = self.notas[1]
        self.matriz[0][3] = self.notas[2]
        self.matriz[0][4] = self.notas[3]
        self.matriz[1][2] = self.notas[4]
        self.matriz[1][3] = self.notas[5]
        self.matriz[1][4] = self.notas[6]
        self.matriz[2][3] = self.notas[7]
        self.matriz[2][4] = self.notas[8]
        self.matriz[3][4] = self.notas[9]
        ...
        for z in range(16):
            if i != j:
                self.matriz[j][i] = (1 / self.matriz[i][j])
                x += 1
            if j < 4:
                j += 1
            else:
        ...
        somaColunas = np.sum(self.matriz, axis=0)
        ...
        notaFinal = np.sum(self.matriz, axis=1)/5
